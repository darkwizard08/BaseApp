...
public class ErrorFragment$$ViewBinder<T extends ru.kazantsev.baseapp.fragments.ErrorFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558530, "field 'errorImage'");
    target.errorImage = finder.castView(view, 2131558530, "field 'errorImage'");
    view = finder.findRequiredView(source, 2131558531, "field 'errorMessage'");
    target.errorMessage = finder.castView(view, 2131558531, "field 'errorMessage'");
