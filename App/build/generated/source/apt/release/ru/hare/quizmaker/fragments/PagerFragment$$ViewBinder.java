...
public class PagerFragment$$ViewBinder<T extends ru.kazantsev.baseapp.fragments.PagerFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558524, "field 'pagerHeader'");
    target.pagerHeader = finder.castView(view, 2131558524, "field 'pagerHeader'");
    view = finder.findRequiredView(source, 2131558523, "field 'pager'");
    target.pager = finder.castView(view, 2131558523, "field 'pager'");
  }
