...
import ru.kazantsev.baseapp.adapter.ItemListAdapter;
import ru.kazantsev.baseapp.adapter.MultiItemListAdapter;
import ru.kazantsev.baseapp.util.*;
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case R.layout.item_file:
                    if(currentDir.getParent() != null && currentDir.getParentFile().equals(getItem(position))) {
                        GuiUtils.setText(holder.getView(R.id.file_name), "\u21A9");
                    } else {
                        GuiUtils.setText(holder.getView(R.id.file_name), getItem(position).getName());
                    }
                    break;
            }
        }
